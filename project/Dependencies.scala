...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.116.Final"
  ...
  private val nettyIoUringLinuxX86           = "io.netty.incubator"                   % "netty-incubator-transport-native-io_uring" % "0.0.26.Final" classifier "linux-x86_64"
  ...
  private val nettyTcNative                  = netty.organization                     % "netty-tcnative-classes"            % "2.0.69.Final"
  ...
  private val xmlresolver                    = "org.xmlresolver"                      % "xmlresolver"                       % "6.0.11"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.18.2"
  ...
  private val bouncyCastle                   = "io.gatling"                           % "gatling-recorder-bc-shaded"        % "1.79.0"
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                      % "9.4.56.v20240826"  % Test
  ...
  private val gatlingMqttVersion = "3.13.1.2"
